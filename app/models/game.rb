...
class Game < ApplicationRecord
  ...
  def start
    ...
    # NewsUpdateJob.set(wait: 12.minutes).perform_later(p.values_at(2) + host, "UPDATE: We have been able to establish limited text communication. This phone number should connect you to another survivor. Please stay inside. #{p[3].number}")
